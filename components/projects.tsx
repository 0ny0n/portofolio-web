...
export function Projects() {
  const projects = [
    ...
    },
    {
      ...
      description:
        "A modern, responsive web application that combines barbershop services with a coffee lounge concept, built with clean UI design and smooth navigation to enhance user experience.",
  ...
  return (
    <section
      id="projects"
      className="py-16 px-4 sm:px-6 lg:px-8 bg-card bg-background"
    >
